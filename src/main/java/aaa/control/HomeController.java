...
public class HomeController {
	...
	String joinForm(Member mem) {	
		// Member mem 이 있어야 joinForm을 get으로 얻었을 때 멤버요소에 접근가능하여 에러가 나지 않는다.
		// 반대로 Member mem 이 없다면 에러 발생
		// @Valid Member mem 매개변수에 @Valid를 넣으면 유효성 검사하여 에러메세지를 출력하려는 에러가 발생한다.
