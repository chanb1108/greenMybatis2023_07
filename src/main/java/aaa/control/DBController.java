...
public class DBController {
	...
	String dbInsertList(Model mm) {
		...
		arr.add(new BoardDTO("무슨제목12", "칠공2", "1111", "무슨 내용2"));
		arr.add(new BoardDTO("무슨제목13", "칠공3", "1111", "무슨 내용3"));
	...
	String dbDeleteComplete(Model mm, BoardDTO dto) {
		...
		if(cnt==1) {
			...
			mm.addAttribute("msg","비밀번호가 틀렸습니다.");
	...
	String dbModifyeForm(Model mm, BoardDTO dto) {
